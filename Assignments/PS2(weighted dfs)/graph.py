...
class WeightedEdge(Edge):
    ...
    def __str__(self):
        """ output a->b (15,10) to represent source node a to destination node b
        with total distance 15 and outdoor distance 10"""
        return str(self.get_source()) + '->' + str(self.get_destination()) + ' (' + \
